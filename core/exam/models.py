...
class FavoriteCategory(models.Model):
    student = models.ForeignKey(User, on_delete=models.CASCADE, related_name="favorite_categories")
    category = models.ForeignKey(Category, on_delete=models.PROTECT, related_name="favorites")
...
class Participation(models.Model):
    ...
    student = models.ForeignKey(User, on_delete=models.CASCADE, related_name="participants")
...
class Score(models.Model):
    ...
    rank = models.CharField(choices=choices.SCORE_RANKS, default=choices.UNRANKED, max_length=20)
    created = models.DateTimeField(auto_now_add=True)
